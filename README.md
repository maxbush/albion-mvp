...
| `/seed10 <TG1> <TG2>` | 🌱 Создать 10 учеников + 3 репетиторов одной командой | `/seed10 333 444` |
| `/demo_reset` | 🗑 Сброс инцидентов/workflow между прогонами | — |
| `/incidents` | 📋 Активные + закрытые инциденты + статистика | — |
| `/today` | 📅 Обзор: классы, действия, workflow'ы | — |
